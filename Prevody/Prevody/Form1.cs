    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton2.Checked)
            {
                foreach (char i in maskedTextBox1.Text)
                {
                    if (i != '0' && i !='1'&&i!='2'&&i!='3'&&i!='4'&&i!='5'&&i!='6'&&i!='7'&&i!='8'&&i!='9'&&i!=','&&i!='.'&&i!= ':' &&proslo==true)
                    {
                        MessageBox.Show("Zadali jste špatně soustavu.", "Chyba", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        proslo = false;
                    }
            ...
            if(radioButton3.Checked)
            {
                ...
                foreach (char i in maskedTextBox1.Text)
                {
                    if (i != '0' && i != '1' && i != '2' && i != '3' && i != '4' && i != '5' && i != '6' && i != '7' && i != '8' && i != '9' && i != 'A' && i != 'B' && i != 'C' && i != 'D' && i != 'E' && i != 'F' && i != 'a' && i != 'b' && i != 'c' && i != 'd' && i != 'e' && i != 'f' && i != ',' && i != '.' && i != ':' && proslo == true)
                    {
                        MessageBox.Show("Zadali jste špatně soustavu.", "Chyba", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        proslo = false;
                    }
                ...
                if (proslo == true)
                {
                    if (radioButton4.Checked)
                    {
                        ...
                        reseni5 = Convert.ToString(Convert.ToInt64(kus5, 16), 2);
                        reseni6 = Convert.ToString(Convert.ToInt64(kus6, 16), 2);
                        reseni7 = Convert.ToString(Convert.ToInt64(kus7, 16), 2);
                        reseni8 = Convert.ToString(Convert.ToInt64(kus8, 16), 2);
                        MessageBox.Show(reseni1 + "." + reseni2 + "." + reseni3 + "." + reseni4+ reseni5 + "." + reseni6 + "." + reseni7 + "." + reseni8, "Výsledek v binární soustavě", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    if (radioButton5.Checked)
                    {
                        ...
                        reseni05 = Convert.ToInt64(kus5, 16);
                        reseni06 = Convert.ToInt64(kus6, 16);
                        reseni07 = Convert.ToInt64(kus7, 16);
                        reseni08 = Convert.ToInt64(kus8, 16);
                        MessageBox.Show(reseni01 + "." + reseni02 + "." + reseni03 + "." + reseni04 + reseni05 + "." + reseni06 + "." + reseni07 + "." + reseni08, "Výsledek v decimální soustavě", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }  
            }
        }
        ...
        {
            maskedTextBox1.Mask = "aaaa:aaaa:aaaa:aaaa:aaaa:aaaa:aaaa:aaaa";
        }
    }
}
